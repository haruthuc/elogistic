 ...
 */
Ext.define("Ext.ux.grid.BillPrinter", {
	...
	statics: {
		...
		print: function(grid) {
			...
			var htmlMarkup = [
				...
				'<html>',
				  ...
				  '</head>',
				  '<body style="width:80mm;font-size:10px;">',
				    '<table>',
				      headings,
				      '<tpl for=".">',
				        body,
		...
		headerTpl: [ 
			'<tr>',
				'<tpl for=".">',
					'<th style="font-weight:bold;border:dotted 1px #CCCCCC;">{text}</th>',
				'</tpl>',
			'</tr>'
		],
			...
			'<tr>',
				'<tpl for=".">',
					'<tpl if="text==\'Tên\'">',
							...
							'<td colspan="5" style="font-weight:bold;border-top:dashed 1px #CCCCCC;">\{{dataIndex}\}</td>',
						'</tr><tr><td></td>',	
					'</tpl>',
					'<tpl if="text!=\'Tên\'">',
						'<td>\{{dataIndex}\}</td>',
